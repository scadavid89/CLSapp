...
/* ---------------- catalog ----------------
   uom: base unit first, each level carries qty of the BASE unit.
   rates: day / week (7 cal days) / month (28 days, rental-industry convention) */
const DESC = {
  "SCL-1930": "19 ft working height on a 30 in deck, non-marking tires. Fits a standard doorway and a passenger elevator.",
  "GEN-25K": "25 kW towable diesel, 120/240V single and three phase. 60-gallon tank runs about 24 hours at half load.",
  "LTW-4H": "Four heads on a 30 ft mast, towable, roughly 60 run hours per fill.",
  "ACP-5T": "5-ton portable spot cooler, 60,000 BTU, ducted supply and return. 208V single phase.",
  "DHU-150": "150 pints per day low-grain refrigerant unit for slab dry-down and post-flood work.",
  "PDU-100": "100A temporary distribution, main breaker with GFCI-protected 120V and 240V outlets.",
  "TRL-824": "8 x 24 ft office trailer, two rooms, HVAC, steps and skirting included. Set and knockdown quoted separately.",
  "CON-20S": "20 ft wind and watertight container, ground level, double doors, lockbox.",
  "FNC-612": "6 x 12 ft galvanized panel with feet and clamps. Windscreen and gates priced separately.",
  "CHR-TSK": "Mesh-back task chair, adjustable arms and lumbar. Stacks six to a dolly.",
  "TBL-6FT": "6 ft folding table, laminate top, steel frame. Ten to a bundle.",
  "DSK-60J": "60 in steel jobsite desk with a full-width plan drawer and cable pass-through.",
  "FIL-4DR": "Four-drawer lateral file, one-hour fire rating, key lock.",
  "PLN-RCK": "Rolling plan rack, twelve pivoting arms, holds up to 1,200 sheets.",
  "LAP-R15": "15 in semi-rugged laptop, spill-resistant keyboard, docking-ready, imaged to your standard build.",
  "MON-27C": "27 in 1440p monitor with clamp-mount arm. Ships as a kit of two for dual setups.",
  "PLT-36W": "36 in wide-format plotter with stand and catch basket. Media and ink billed at cost.",
  "WIF-LTE": "LTE gateway, outdoor access point, PoE injector, weatherproof enclosure.",
  "PRJ-4KC": "4K projector, 4,000 lumens, with tripod screen and HDMI run.",
  "CAM-SIT": "Solar site camera on 4G with time-lapse capture, motion alerts, and a 60-day cloud archive.",
};
let CATALOG = [
  { sku: "SCL-1930", name: 'Scissor Lift 19ft Electric', cat: "Equipment", ser: true, cost: 18500, life: 84, salv: 4200, rates: { day: 145, week: 425, month: 1150 }, uom: [["Each", 1]], qty: 6, meter: true },
  { sku: "GEN-25K", name: "Towable Generator 25kW", cat: "Equipment", ser: true, cost: 22400, life: 96, salv: 5000, rates: { day: 225, week: 675, month: 1875 }, uom: [["Each", 1]], qty: 4, meter: true },
  { sku: "LTW-4H", name: "Light Tower 4-Head Diesel", cat: "Equipment", ser: true, cost: 9800, life: 84, salv: 1800, rates: { day: 95, week: 285, month: 760 }, uom: [["Each", 1]], qty: 5, meter: true },
  { sku: "ACP-5T", name: "Portable AC 5-Ton Spot Cooler", cat: "Equipment", ser: true, cost: 7600, life: 72, salv: 900, rates: { day: 135, week: 405, month: 1080 }, uom: [["Each", 1]], qty: 6 },
  { sku: "DHU-150", name: "Dehumidifier 150 PPD", cat: "Equipment", ser: true, cost: 3400, life: 60, salv: 400, rates: { day: 75, week: 225, month: 600 }, uom: [["Each", 1]], qty: 5 },
  { sku: "PDU-100", name: "Temp Power Distro 100A", cat: "Equipment", ser: true, cost: 4100, life: 96, salv: 600, rates: { day: 60, week: 180, month: 480 }, uom: [["Each", 1]], qty: 4 },
  { sku: "TRL-824", name: "Job Trailer 8x24 Office", cat: "Structures", ser: true, cost: 32000, life: 120, salv: 9500, rates: { day: 0, week: 0, month: 875 }, uom: [["Each", 1]], qty: 5 },
  { sku: "CON-20S", name: "Storage Container 20ft", cat: "Structures", ser: true, cost: 5200, life: 180, salv: 1600, rates: { day: 0, week: 0, month: 195 }, uom: [["Each", 1]], qty: 8 },
  { sku: "FNC-612", name: "Temp Fence Panel 6x12", cat: "Structures", ser: false, cost: 78, life: 96, salv: 12, rates: { day: 0, week: 1.9, month: 4.5 }, uom: [["Panel", 1], ["Bundle", 12], ["Truckload", 240]], qty: 960 },
  { sku: "CHR-TSK", name: "Task Chair Mesh Back", cat: "Furnishings", ser: false, cost: 165, life: 60, salv: 15, rates: { day: 0, week: 8, month: 22 }, uom: [["Each", 1], ["Stack", 6], ["Pallet", 36]], qty: 288 },
  { sku: "TBL-6FT", name: "Folding Table 6ft", cat: "Furnishings", ser: false, cost: 128, life: 72, salv: 10, rates: { day: 0, week: 7, month: 18 }, uom: [["Each", 1], ["Bundle", 10]], qty: 140 },
  { sku: "DSK-60J", name: 'Jobsite Desk 60in Steel', cat: "Furnishings", ser: false, cost: 420, life: 84, salv: 40, rates: { day: 0, week: 16, month: 44 }, uom: [["Each", 1], ["Pallet", 8]], qty: 96 },
  { sku: "FIL-4DR", name: "Fire File 4-Drawer Lateral", cat: "Furnishings", ser: false, cost: 980, life: 120, salv: 120, rates: { day: 0, week: 24, month: 68 }, uom: [["Each", 1]], qty: 42 },
  { sku: "PLN-RCK", name: "Plan Rack Rolling 12-Arm", cat: "Furnishings", ser: false, cost: 340, life: 84, salv: 30, rates: { day: 0, week: 12, month: 33 }, uom: [["Each", 1]], qty: 36 },
  { sku: "LAP-R15", name: "Rugged Laptop 15in", cat: "Technology", ser: true, cost: 2400, life: 36, salv: 180, rates: { day: 45, week: 135, month: 385 }, uom: [["Each", 1]], qty: 14 },
  { sku: "MON-27C", name: 'Monitor 27in + Arm', cat: "Technology", ser: true, cost: 310, life: 48, salv: 25, rates: { day: 12, week: 32, month: 85 }, uom: [["Each", 1], ["Kit of 2", 2]], qty: 24 },
  { sku: "PLT-36W", name: "Plotter 36in Wide-Format", cat: "Technology", ser: true, cost: 6200, life: 48, salv: 500, rates: { day: 110, week: 330, month: 890 }, uom: [["Each", 1]], qty: 4 },
  { sku: "WIF-LTE", name: "Jobsite Wi-Fi Kit LTE", cat: "Technology", ser: true, cost: 1850, life: 36, salv: 100, rates: { day: 55, week: 165, month: 445 }, uom: [["Each", 1]], qty: 9 },
  { sku: "PRJ-4KC", name: "Conference Projector 4K", cat: "Technology", ser: true, cost: 2900, life: 48, salv: 200, rates: { day: 85, week: 255, month: 690 }, uom: [["Each", 1]], qty: 5 },
  { sku: "CAM-SIT", name: "Site Camera Solar 4G", cat: "Technology", ser: true, cost: 3600, life: 48, salv: 250, rates: { day: 0, week: 195, month: 520 }, uom: [["Each", 1]], qty: 7 },
].map((c) => ({ desc: DESC[c.sku] || "", ...c }));
function setCatalog(c) { CATALOG = c; }

/* Directory is mutable so the Contractors module can edit it in place.
   In production these are two tables; here a module binding plus a version
   counter in App is enough to keep every read site working unchanged. */
let CUSTOMERS = [
  { id: "C-101", name: "Suncoast Builders Group", terms: "Net 30", qbo: "QBO:87", city: "Tampa", disc: 8, credit: "ok", contact: "Tom Whitfield", phone: "813-555-0142" },
  { id: "C-102", name: "Baycrest Construction", terms: "Net 30", qbo: "QBO:104", city: "St. Petersburg", disc: 5, credit: "ok", contact: "J. Okafor", phone: "727-555-0119" },
  { id: "C-103", name: "Meridian Contracting LLC", terms: "Net 45", qbo: "QBO:119", city: "Orlando", disc: 12, credit: "ok", contact: "Renee Salas", phone: "407-555-0188" },
  { id: "C-104", name: "Gulfstream Industrial", terms: "Net 30", qbo: "QBO:66", city: "Sarasota", disc: 0, credit: "ok", contact: "Mark Devlin", phone: "941-555-0173" },
  { id: "C-105", name: "Palmetto Build Partners", terms: "Due on receipt", qbo: null, city: "Lakeland", disc: 0, credit: "hold", contact: "Ana Ruiz", phone: "863-555-0104" },
  { id: "C-106", name: "Vertex General Contractors", terms: "Net 30", qbo: "QBO:141", city: "Jacksonville", disc: 6, credit: "ok", contact: "Dale Frank", phone: "904-555-0167" },
];
let SITES = [
  { name: "Water Street Tower 3", cust: "C-101", county: "Hillsborough", zone: 165, super: "R. Kinney", active: true },
  { name: "Ybor Logistics Center", cust: "C-101", county: "Hillsborough", zone: 145, super: "L. Batiste", active: true },
  { name: "Riverwalk Hotel Ph 2", cust: "C-102", county: "Pinellas", zone: 225, super: "P. Nunes", active: true },
  { name: "Gandy Medical Pavilion", cust: "C-102", county: "Pinellas", zone: 210, super: "S. Ortega", active: true },
  { name: "Lake Nona Data Hall B", cust: "C-103", county: "Orange", zone: 395, super: "K. Mbeki", active: true },
  { name: "I-4 Ultimate Field Office", cust: "C-103", county: "Orange", zone: 370, super: "C. Vance", active: true },
  { name: "Port Manatee Berth 4", cust: "C-104", county: "Manatee", zone: 285, super: "H. Cole", active: true },
  { name: "Polk Distribution Center", cust: "C-105", county: "Polk", zone: 265, super: "B. Yates", active: true },
  { name: "Southbank Mixed-Use", cust: "C-106", county: "Duval", zone: 585, super: "G. Ifill", active: false },
];
function setDirectory(c, s) { if (c) CUSTOMERS = c; if (s) SITES = s; }
...
function buildFleet() {
  ...
  const bulk = [];
  CATALOG.forEach((c) => {
    const r = mulberry32(hash(c.sku));
    if (c.ser) {
      for (let i = 1; i <= c.qty; i++) {
        const tag = "FL-" + String(hash(c.sku + i) % 9000 + 1000);
        const ageM = Math.floor(r() * (c.life * 0.72));
        const inSvc = new Date(TODAY.getFullYear(), TODAY.getMonth() - ageM, 12);
        const roll = r();
        let status = roll < 0.46 ? "On rent" : roll < 0.86 ? "Available" : roll < 0.94 ? "In service" : "In transit";
        const site = SITES[Math.floor(r() * SITES.length)];
        const start = addDays(TODAY, -Math.floor(r() * 70) - 3);
        const termIdx = c.rates.day ? Math.floor(r() * 3) : 2;
        const term = ["day", "week", "month"][termIdx];
        const spanDays = term === "day" ? 1 + Math.floor(r() * 5) : term === "week" ? 7 * (1 + Math.floor(r() * 3)) : 28 * (1 + Math.floor(r() * 4));
        const due = addDays(start, spanDays);
        assets.push({
          id: c.sku + "-" + i, tag, sku: c.sku, name: c.name, cat: c.cat, cost: c.cost, life: c.life,
          salv: c.salv, inSvc, status, rates: c.rates, uom: c.uom, meter: c.meter ? Math.floor(r() * 3200) + 90 : null,
          cust: status === "On rent" || status === "In transit" ? site.cust : null,
          site: status === "On rent" || status === "In transit" ? site.name : null,
          term: status === "On rent" || status === "In transit" ? term : null,
          start: status === "On rent" || status === "In transit" ? start : null,
          due: status === "On rent" || status === "In transit" ? due : null,
          ltdRev: Math.round(c.cost * (0.22 + r() * 1.5) * (ageM / 12 || 0.4)),
          bin: "Row " + String.fromCharCode(65 + Math.floor(r() * 6)) + "-" + (1 + Math.floor(r() * 14)),
          cond: r() < 0.08 ? "Damage hold" : r() < 0.2 ? "Fair" : "Good",
        });
      }
    } else {
      const r2 = mulberry32(hash(c.sku + "b"));
      const onRent = Math.round(c.qty * (0.25 + r2() * 0.45));
      const svc = Math.round(c.qty * r2() * 0.06);
      const ageM = 12 + Math.floor(r2() * 40);
      bulk.push({
        id: c.sku, sku: c.sku, name: c.name, cat: c.cat, cost: c.cost, life: c.life, salv: c.salv,
        inSvc: new Date(TODAY.getFullYear(), TODAY.getMonth() - ageM, 8), rates: c.rates, uom: c.uom,
        total: c.qty, onRent, svc, avail: c.qty - onRent - svc, bulk: true,
        ltdRev: Math.round(c.cost * c.qty * (0.3 + r2() * 0.5)),
        bin: "Yard " + String.fromCharCode(65 + Math.floor(r2() * 4)),
      });
    }
  });
  return { assets, bulk };
}
const { assets: SEED_ASSETS, bulk: SEED_BULK } = buildFleet();
...
const COUNTY_SURTAX = { Hillsborough: 1.5, Pinellas: 1.0, Orange: 0.5, Manatee: 1.0, Polk: 1.5, Duval: 1.5 };
const STATE_TAX = 6.0, WAIVER_PCT = 12, ENVIRO_PCT = 2.5, APPROVAL_AT = 15, DEPOSIT_PCT = 25, HOLD_DAYS = 14;
...
/* Availability is a window query, never a point-in-time count. */
...
function priceLine(line, custId) {
  ...
  const floor = ((cat.cost - cat.salv) / cat.life) * 1.8;
...
function quoteTotals(q) {
  ...
  const waiver = q.waiver ? (rental * WAIVER_PCT) / 100 : 0;
  const freight = q.delivery ? (site.zone || 200) * 2 : 0;
  const enviro = (rental * ENVIRO_PCT) / 100;
  const taxable = rental + waiver + freight + enviro;
  const rate = STATE_TAX + (COUNTY_SURTAX[site.county] != null ? COUNTY_SURTAX[site.county] : 1);
  ...
  return {
    ...
    deposit: (total * DEPOSIT_PCT) / 100, maxDisc, hold,
    under: priced.some((x) => x.p.under),
    approval: maxDisc > APPROVAL_AT || hold,
...
const SEED_QUOTES = [
  {
    id: "Q-2418", cust: "C-101", site: "Water Street Tower 3", status: "Sent", po: "WS3-0442",
    waiver: true, delivery: true, created: addDays(TODAY, -3), expires: addDays(TODAY, 11),
    start: addDays(TODAY, 14), end: addDays(TODAY, 28),
    lines: [
      { id: 1, sku: "SCL-1930", qty: 2, uomIdx: 0, start: addDays(TODAY, 14), end: addDays(TODAY, 28), disc: 0 },
      { id: 2, sku: "LTW-4H", qty: 3, uomIdx: 0, start: addDays(TODAY, 14), end: addDays(TODAY, 28), disc: 0 },
      { id: 3, sku: "FNC-612", qty: 4, uomIdx: 1, start: addDays(TODAY, 14), end: addDays(TODAY, 70), disc: 0 },
    ],
  },
  {
    id: "Q-2421", cust: "C-103", site: "Lake Nona Data Hall B", status: "Accepted", po: "LN-DH-118",
    waiver: false, delivery: true, created: addDays(TODAY, -9), expires: addDays(TODAY, 5),
    start: addDays(TODAY, 6), end: addDays(TODAY, 90),
    lines: [
      { id: 1, sku: "TRL-824", qty: 1, uomIdx: 0, start: addDays(TODAY, 6), end: addDays(TODAY, 90), disc: 0 },
      { id: 2, sku: "DSK-60J", qty: 6, uomIdx: 0, start: addDays(TODAY, 6), end: addDays(TODAY, 90), disc: 0 },
      { id: 3, sku: "CHR-TSK", qty: 2, uomIdx: 1, start: addDays(TODAY, 6), end: addDays(TODAY, 90), disc: 0 },
      { id: 4, sku: "WIF-LTE", qty: 1, uomIdx: 0, start: addDays(TODAY, 6), end: addDays(TODAY, 90), disc: 0 },
    ],
  },
  {
    id: "Q-2423", cust: "C-102", site: "Riverwalk Hotel Ph 2", status: "Accepted", po: "RW2-3390",
    waiver: true, delivery: true, created: addDays(TODAY, -5), expires: addDays(TODAY, 9),
    start: TODAY, end: addDays(TODAY, 28),
    lines: [
      { id: 1, sku: "SCL-1930", qty: 2, uomIdx: 0, start: TODAY, end: addDays(TODAY, 28), disc: 0 },
      { id: 2, sku: "LTW-4H", qty: 2, uomIdx: 0, start: TODAY, end: addDays(TODAY, 28), disc: 0 },
      { id: 3, sku: "ACP-5T", qty: 2, uomIdx: 0, start: TODAY, end: addDays(TODAY, 28), disc: 0 },
      { id: 4, sku: "TBL-6FT", qty: 2, uomIdx: 1, start: TODAY, end: addDays(TODAY, 28), disc: 0 },
    ],
  },
  {
    id: "Q-2425", cust: "C-105", site: "Polk Distribution Center", status: "Draft", po: "",
    waiver: true, delivery: true, created: addDays(TODAY, -1), expires: addDays(TODAY, 13),
    start: addDays(TODAY, 3), end: addDays(TODAY, 12),
    lines: [
      { id: 1, sku: "GEN-25K", qty: 1, uomIdx: 0, start: addDays(TODAY, 3), end: addDays(TODAY, 12), disc: 22 },
    ],
  },
  {
    id: "Q-2409", cust: "C-106", site: "Southbank Mixed-Use", status: "Lost", po: "",
    waiver: true, delivery: true, created: addDays(TODAY, -26), expires: addDays(TODAY, -12),
    start: addDays(TODAY, -18), end: addDays(TODAY, -4), lostTo: "Availability",
    lines: [{ id: 1, sku: "ACP-5T", qty: 4, uomIdx: 0, start: addDays(TODAY, -18), end: addDays(TODAY, -4), disc: 0 }],
  },
].map((q) => ({ packed: [], returned: [], ...q }));
const Q_PILL = {
...
export default function App() {
  ...
  const [bulk, setBulk] = useState(SEED_BULK);
  ...
  const [, setDirV] = useState(0);
  const commit = (c, sx) => { setDirectory(c, sx); setDirV((n) => n + 1); };
  const commitCatalog = (c) => { setCatalog(c); setDirV((n) => n + 1); };
  ...
  const NAV = [
    ...
    ["fleet", "Fleet", Layers, assets.length + SEED_BULK.length],
    ...
    <div className="ld">
      ...
      <nav className="rail">
        ...
        <div className="railfoot">
          <b>Tampa yard</b><br />m.reyes@<br />Yard lead
        </div>
      </nav>
      ...
      <main className="main">
        ...
        <div className="wrap">
          ...
          {view === "scan" && <ScanBay assets={assets} setAssets={setAssets} bulk={bulk} quotes={quotes}
            setQuotes={setQuotes} log={log} push={push} onPick={setSel} setSheet={setSheet} />}
          {view === "fleet" && <Fleet assets={assets} setAssets={setAssets} bulk={bulk} setBulk={setBulk}
            commitCatalog={commitCatalog} onPick={setSel} />}
          {view === "quotes" && <Quotes quotes={quotes} setQuotes={setQuotes} assets={assets} bulk={bulk}
            setDoc={setDoc} onPost={() => setQueue((n) => n + 1)} />}
          {view === "contractors" && <Contractors assets={assets} quotes={quotes} commit={commit} />}
...
function ScanBay({ assets, setAssets, bulk, quotes, setQuotes, log, push, onPick, setSheet }) {
  ...
  const confirmLoad = () => {
    const days = spanDays(order.start, order.end);
    setAssets((prev) => prev.map((a) => session.includes(a.tag) ? {
      ...a, status: "On rent", cust: order.cust, site: order.site,
      term: days >= 28 ? "month" : days >= 7 ? "week" : "day", start: TODAY, due: order.end,
    } : a));
    setQuotes((qs) => qs.map((x) => x.id === order.id
      ? { ...x, status: "Dispatched", packed: [...x.packed, ...session], dispatchedAt: TODAY } : x));
  ...
  const confirmReturn = () => {
    setAssets((prev) => prev.map((a) => session.includes(a.tag)
      ? { ...a, status: "Available", cust: null, site: null, term: null, start: null, due: null } : a));
    setQuotes((qs) => qs.map((x) => {
      const hit = session.filter((t) => x.packed.includes(t) && !x.returned.includes(t));
      if (!hit.length) return x;
      const returned = [...x.returned, ...hit];
      return { ...x, returned, status: returned.length >= x.packed.length ? "Returned" : x.status };
    }));
  ...
  const adhoc = (kind) => {
    if (!found) return;
    const sRec = siteRec(site);
    setAssets((prev) => prev.map((x) => x.id !== found.id ? x : (
      kind === "out"
        ? { ...x, status: "On rent", cust: sRec.cust, site, term, start: TODAY, due: addDays(TODAY, term === "day" ? 1 : term === "week" ? 7 : 28) }
        : { ...x, status: "Available", cust: null, site: null, term: null, start: null, due: null }
    )));
    push(kind === "out" ? "OUT" : "IN", found.tag, kind === "out" ? site : "returned to " + found.bin);
    setFound(null);
        ...
        {active && (
          <div className="panel slide">
            ...
            <div style={{ padding: 14, borderTop: "1px solid var(--line-2)", display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
              <button className="btn sig" disabled={!ready} onClick={mode === "out" ? confirmLoad : confirmReturn}>
                <Check size={15} /> {mode === "out" ? "Confirm load & dispatch" : "Confirm return"}
              </button>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {mode === "in" && found.status !== "Available" && (
                  <div style={{ marginTop: 14, borderTop: "1px solid var(--line-2)", paddingTop: 13, display: "flex", gap: 8, flexWrap: "wrap" }}>
                    ...
                    <button className="btn ghost" onClick={() => adhoc("in")}><Wrench size={14} /> Receive into service</button>
                  </div>
                )}
                {mode === "in" && found.status === "Available" && (
                  <div className="notice" style={{ marginTop: 14 }}>
...
function Fleet({ assets, setAssets, bulk, setBulk, commitCatalog, onPick }) {
  ...
  const saveModel = (rec, isNew) => {
    commitCatalog(isNew ? [...CATALOG, rec] : CATALOG.map((c) => (c.sku === rec.sku ? rec : c)));
    if (!isNew) {
      setAssets((prev) => prev.map((a) => a.sku !== rec.sku ? a
        : { ...a, name: rec.name, cat: rec.cat, rates: rec.rates, uom: rec.uom }));
      setBulk((prev) => prev.map((b) => b.sku !== rec.sku ? b
        : { ...b, name: rec.name, cat: rec.cat, rates: rec.rates, uom: rec.uom }));
    }
    setForm(null);
  };
  ...
  return (
    <div className="grid" style={{ gap: 14 }}>
      ...
      {form && form.kind === "asset" &&
        <AssetForm item={form.item} assets={assets} setAssets={setAssets} saveModel={saveModel} close={() => setForm(null)} />}
      {form && form.kind === "bulk" &&
        <BulkForm item={form.item} bulk={bulk} setBulk={setBulk} close={() => setForm(null)} />}
...
function AssetForm({ item, assets, setAssets, saveModel, close }) {
  const editing = !!item;
  ...
  const save = () => {
    if (modelDirty) saveModel({ ...cat, name: model.name.trim() || cat.name, desc: model.desc.trim() }, false);
    if (editing) {
      setAssets((prev) => prev.map((a) => a.id !== item.id ? a : {
        ...a, tag: f.tag.trim().toUpperCase() || a.tag, status: f.status, cond: f.cond, bin: f.bin,
        meter: f.meter === "" ? null : +f.meter, cost: +f.cost, inSvc: fromIso(f.inSvc),
        life: +f.life, salv: +f.salv,
        ...(f.status === "Available" ? { cust: null, site: null, term: null, start: null, due: null } : {}),
      }));
    } else {
      setAssets((prev) => {
        const made = [];
        ...
        for (let i = 0; i < count; i++) {
          const tag = nextTag([...pool, ...made]);
          made.push({
            id: sku + "-N" + (Date.now() + i), tag, sku, name: cat.name, cat: cat.cat,
            cost: +f.cost, life: +f.life, salv: +f.salv, inSvc: fromIso(f.inSvc),
            status: "Available", rates: cat.rates, uom: cat.uom,
            meter: cat.meter ? 0 : null, cust: null, site: null, term: null, start: null, due: null,
            ltdRev: 0, bin: f.bin, cond: f.cond,
          });
        }
        return [...prev, ...made];
      });
  ...
  return (
    <div className="mwrap" onClick={close}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mbody">
          {!editing && (
            <>
              ...
              <Field label="Next tags" hint="Print the labels before these leave the receiving dock.">
                <div className="mono" style={{ fontSize: 12.5, paddingTop: 7 }}>
                  {nextTag(assets)}{count > 1 ? " … FL-" + (parseInt(nextTag(assets).split("-")[1], 10) + count - 1) : ""}
                </div>
              </Field>
            </>
          )}
        ...
        <div className="mfoot">
          <button className="btn ghost sm" onClick={close}>Cancel</button>
          <button className="btn sig sm" onClick={save}>
            <Check size={13} /> {editing ? "Save changes" : "Receive " + count + " unit" + (count > 1 ? "s" : "")}
          </button>
        </div>
      </div>
    </div>
...
function BulkForm({ item, bulk, setBulk, close }) {
  const editing = !!item;
  ...
  const save = () => {
    const add = +f.add || 0;
    if (editing) {
      setBulk((prev) => prev.map((b) => b.id !== item.id ? b : {
        ...b, total: b.total + add, avail: b.avail + add - (+f.svc - b.svc), svc: +f.svc,
        cost: +f.cost, life: +f.life, salv: +f.salv, inSvc: fromIso(f.inSvc), bin: f.bin,
      }));
    } else if (existing) {
      setBulk((prev) => prev.map((b) => b.id !== existing.id ? b : {
        ...b, total: b.total + add, avail: b.avail + add, cost: +f.cost,
      }));
    } else {
      setBulk((prev) => [...prev, {
        id: cat.sku, sku: cat.sku, name: cat.name, cat: cat.cat, cost: +f.cost, life: +f.life,
        salv: +f.salv, inSvc: fromIso(f.inSvc), rates: cat.rates, uom: cat.uom,
        total: add, onRent: 0, svc: 0, avail: add, bulk: true, ltdRev: 0, bin: f.bin,
      }]);
    }
    close();
  };
  ...
  return (
    <div className="mwrap" onClick={close}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mfoot">
          <button className="btn ghost sm" onClick={close}>Cancel</button>
          <button className="btn sig sm" onClick={save}><Check size={13} /> {editing ? "Save changes" : "Receive stock"}</button>
        </div>
      </div>
    </div>
  );
...
/* ---------------- CPQ: QUOTE DESK ---------------- */
function Quotes({ quotes, setQuotes, assets, bulk, setDoc, onPost }) {
  const [openId, setOpenId] = useState(null);
  const q = quotes.find((x) => x.id === openId);
  return q
    ? <QuoteBuilder q={q} quotes={quotes} setQuotes={setQuotes} assets={assets} bulk={bulk}
        back={() => setOpenId(null)} setDoc={setDoc} onPost={onPost} />
    : <QuoteList quotes={quotes} setQuotes={setQuotes} open={setOpenId} setDoc={setDoc} />;
}

function QuoteList({ quotes, setQuotes, open, setDoc }) {
  const newQuote = () => {
    const id = "Q-" + (2426 + quotes.filter((x) => x.id.startsWith("Q-24")).length);
    const start = addDays(TODAY, 7), end = addDays(TODAY, 21);
    setQuotes((qs) => [{
      id, cust: "C-101", site: SITES[0].name, status: "Draft", po: "", waiver: true, delivery: true,
      created: TODAY, expires: addDays(TODAY, HOLD_DAYS), start, end, lines: [], packed: [], returned: [],
    }, ...qs]);
    open(id);
  };
    ...
    <div className="grid" style={{ gap: 14 }}>
      <div className="grid g4">
        ...
        <div className="stat">
          ...
          <div className="f">discount over {APPROVAL_AT}% or credit hold</div>
        </div>
      </div>
...
function QuoteBuilder({ q, quotes, setQuotes, assets, bulk, back, setDoc, onPost }) {
  const t = quoteTotals(q);
  const cust = CUSTOMERS.find((c) => c.id === q.cust) || {};
  const locked = q.status !== "Draft";

  const upd = (patch) => setQuotes((qs) => qs.map((x) => (x.id === q.id ? { ...x, ...patch } : x)));
  const updLine = (lid, patch) => setQuotes((qs) => qs.map((x) => x.id === q.id
    ? { ...x, lines: x.lines.map((l) => (l.id === lid ? { ...l, ...patch } : l)) } : x));
  const delLine = (lid) => setQuotes((qs) => qs.map((x) => x.id === q.id ? { ...x, lines: x.lines.filter((l) => l.id !== lid) } : x));
  const addLine = (sku) => setQuotes((qs) => qs.map((x) => x.id === q.id ? {
    ...x, lines: [...x.lines, { id: Date.now(), sku, qty: 1, uomIdx: 0, start: x.start, end: x.end, disc: 0 }],
  } : x));

  /* moving the header window drags any line that was still following it */
  const moveWindow = (which, v) => {
    const d = fromIso(v), old = q[which];
    setQuotes((qs) => qs.map((x) => x.id === q.id ? {
      ...x, [which]: d,
      lines: x.lines.map((l) => (+l[which] === +old ? { ...l, [which]: d } : l)),
    } : x));
  };

  const send = () => upd({ status: "Sent", expires: addDays(TODAY, HOLD_DAYS) });
  const accept = () => upd({ status: "Accepted" });
  const postEstimate = () => { upd({ posted: true }); onPost(); };

  const sites = SITES.filter((sx) => sx.cust === q.cust && sx.active !== false);

  return (
    <div className="grid" style={{ gap: 14 }}>
      <div className="panel" style={{ padding: 12, display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
        <button className="btn ghost sm" onClick={back}><ArrowLeft size={13} /> All quotes</button>
        <span className="mono" style={{ fontWeight: 500, fontSize: 15 }}>{q.id}</span>
        <span className={"pill " + (Q_PILL[q.status] || "p-svc")}>{q.status}</span>
        <div style={{ marginLeft: "auto", display: "flex", gap: 8, flexWrap: "wrap" }}>
          <button className="btn ghost sm" onClick={() => setDoc(q.id)}><FileText size={13} /> Generate quote</button>
          {q.status === "Draft" && <button className="btn sig sm" disabled={!q.lines.length || t.approval} onClick={send}><Send size={13} /> Reserve &amp; send</button>}
          {q.status === "Sent" && <><button className="btn sm" onClick={accept}><Check size={13} /> Mark accepted</button>
            <button className="btn ghost sm" onClick={() => upd({ status: "Lost", lostTo: "Price" })}>Mark lost</button></>}
          {q.status === "Accepted" && !q.posted && <button className="btn sm" onClick={postEstimate}><RefreshCw size={13} /> Post to QuickBooks</button>}
          {q.status === "Accepted" && <span className="mono" style={{ fontSize: 11, color: "var(--muted)", alignSelf: "center" }}>Load it in the Scan bay</span>}
        </div>
      </div>
      ...
      <div className="qgrid">
        <div style={{ display: "flex", flexDirection: "column", gap: 14, minWidth: 0 }}>
          <div className="panel">
            ...
            <div className="qhead">
              <div className="field">
                ...
                <select className="input" value={q.cust} disabled={locked}
                  onChange={(e) => { const c = e.target.value; const first = SITES.find((sx) => sx.cust === c); upd({ cust: c, site: first ? first.name : q.site }); }}>
                  {CUSTOMERS.map((c) => <option key={c.id} value={c.id}>{c.name}</option>)}
                </select>
              </div>
              <div className="field">
                <label>Jobsite</label>
                <select className="input" value={q.site} disabled={locked} onChange={(e) => upd({ site: e.target.value })}>
                  {sites.map((sx) => <option key={sx.name} value={sx.name}>{sx.name}</option>)}
                </select>
              </div>
              <div className="field">
                <label>On rent from</label>
                <input className="input" type="date" value={iso(q.start)} disabled={locked} onChange={(e) => moveWindow("start", e.target.value)} />
              </div>
              <div className="field">
                <label>Expected return</label>
                <input className="input" type="date" value={iso(q.end)} disabled={locked} onChange={(e) => moveWindow("end", e.target.value)} />
              </div>
              <div className="field">
                <label>Customer PO</label>
                <input className="input" value={q.po} disabled={locked} placeholder="optional" onChange={(e) => upd({ po: e.target.value })} />
              </div>
              <div className="field">
                <label>Damage waiver</label>
                <div className="chips">
                  <button className={"chip" + (q.waiver ? " on" : "")} disabled={locked} onClick={() => upd({ waiver: true })}>Yes · {WAIVER_PCT}%</button>
                  <button className={"chip" + (!q.waiver ? " on" : "")} disabled={locked} onClick={() => upd({ waiver: false })}>Declined</button>
                </div>
              </div>
              <div className="field">
                <label>Delivery</label>
                <div className="chips">
                  <button className={"chip" + (q.delivery ? " on" : "")} disabled={locked} onClick={() => upd({ delivery: true })}>Round trip</button>
                  <button className={"chip" + (!q.delivery ? " on" : "")} disabled={locked} onClick={() => upd({ delivery: false })}>Customer pickup</button>
                </div>
              </div>
              <div className="field">
                <label>Window</label>
                <div className="mono" style={{ fontSize: 13, paddingTop: 6 }}>{spanDays(q.start, q.end)} days</div>
              </div>
            </div>
          </div>
          ...
          <div className="panel">
            ...
            {q.lines.length === 0 ? (
              ...
              <table className="tbl">
                ...
                <tbody>
                  {t.priced.map(({ l, p }) => {
                    const av = availableFor(l.sku, l.start, l.end, assets, bulk, quotes, q.id);
          ...
          {!locked && (
            <div className="panel">
              <div className="phead"><h3>Catalog</h3><div className="note">availability for {fmtD(q.start)} – {fmtD(q.end)}</div></div>
              <div className="picker">
                {CATALOG.map((c) => {
                  const av = availableFor(c.sku, q.start, q.end, assets, bulk, quotes, q.id);
                  const lad = ladder(c.rates, spanDays(q.start, q.end));
                  return (
        ...
        <div className="qside">
          {t.approval && (
            <div className="warn">
              ...
              {t.hold
                ...
                : "Line discount reaches " + Math.round(t.maxDisc) + "%, over the " + APPROVAL_AT + "% desk limit. An Ops role has to release it."}
            </div>
          )}
          {t.under && !t.approval && (
            <div className="warn">
          ...
          <div className="panel">
            <div className="phead"><h3>Price</h3><div className="note">{spanDays(q.start, q.end)} days</div></div>
            <div className="wf">
              ...
              <div className="r"><span>Customer rate{termsFor(q.cust).disc ? " (" + termsFor(q.cust).disc + "%)" : ""}</span>
                <span>{money(t.rental - t.list)}</span></div>
              <div className="r sub"><span>Rental subtotal</span><span>{money(t.rental)}</span></div>
              {q.waiver && <div className="r"><span>Damage waiver {WAIVER_PCT}%</span><span>{money(t.waiver)}</span></div>}
              {q.delivery && <div className="r"><span>Delivery + pickup, {t.city}</span><span>{money(t.freight)}</span></div>}
              <div className="r"><span>Environmental {ENVIRO_PCT}%</span><span>{money(t.enviro)}</span></div>
              ...
              <div className="r"><span>Deposit at signing {DEPOSIT_PCT}%</span><span>{money(t.deposit)}</span></div>
            </div>
          </div>
...
function Contractors({ assets, quotes, commit }) {
  ...
  const saveCust = (rec) => {
    const exists = CUSTOMERS.some((c) => c.id === rec.id);
    commit(exists ? CUSTOMERS.map((c) => (c.id === rec.id ? rec : c)) : [...CUSTOMERS, rec], null);
    setForm(null);
  };
  const saveSite = (rec, prevName) => {
    const exists = SITES.some((s) => s.name === prevName);
    commit(null, exists ? SITES.map((s) => (s.name === prevName ? rec : s)) : [...SITES, rec]);
    setForm(null);
  };
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mbody">
          ...
          <div className="full notice">
            ...
            Florida's {STATE_TAX.toFixed(1)}% — an estimate for quoting only. QuickBooks computes the rate that actually invoices.
          </div>
        </div>
        <div className="mfoot">
          <button className="btn ghost sm" onClick={close}>Cancel</button>
